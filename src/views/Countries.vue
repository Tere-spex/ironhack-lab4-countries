<template>
  <div class="uppercase font-bold text-center m-5">Countries</div>
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5" v-if="countries">

    <div v-for="countrie in countries" :key="countrie.url"> <!--la url la utilizare como identificador unico -->
...
export default {
  ...
  methods: {
    ...
    mounted() {//Realiza una accion automática, sin necesidad de un evento. Que en este caso sera el método getCountries
      this.getCountries()
    },
}
</script>
